...
public record KeepAliveRecord(
        boolean success,
        String cause
) {
    public static KeepAliveRecord fromResponseBody(String responseBody) {
        return new Gson().fromJson(responseBody, KeepAliveRecord.class);
    }
}
